...
export const CompareDbDataPage: React.FC<CompareDbDataPageProps> = () => {
    ...
    const startCompare = async () => {
        valueStore(tableInfosRef.current);
    ...
    const valueStore = async (data: any) => {
        await window.electron?.invoke('set-storage-data', 'table-info-cards', data);
    };
